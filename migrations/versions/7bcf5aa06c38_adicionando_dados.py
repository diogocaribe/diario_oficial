...
def upgrade() -> None:
    ...
    op.add_column('publicacao', sa.Column('poder_id', sa.Integer(), nullable=False), schema='processing')
    op.create_foreign_key(op.f('fk_publicacao_poder_id_poder'), 'publicacao', 'poder', ['poder_id'], ['id'], source_schema='processing', referent_schema='dominio')
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(op.f('fk_publicacao_poder_id_poder'), 'publicacao', schema='processing', type_='foreignkey')
